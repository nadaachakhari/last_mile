...
//       // Générer automatiquement le nom d'utilisateur si le nom ou l'email change
//       if (id === 'name' || id === 'email') {
//         const userName = generateUserName(updatedFormData.name, updatedFormData.email)
//         updatedFormData.user_name = userName
//       }
