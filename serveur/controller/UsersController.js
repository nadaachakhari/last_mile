...
//         // Send SMS if the state changes to "Livraison imminente"
//         if (newState === 'Livraison imminente') {
//             let customerPhoneNumber = order.customer.phone || order.customer.mobile;

//             // Ensure phone number is properly formatted with country code
//             if (customerPhoneNumber && !customerPhoneNumber.startsWith('+')) {
//                 customerPhoneNumber = `+216${customerPhoneNumber}`;
//             }
...
//                         res.status(200).json({ message: 'État de la commande mis à jour avec succès et SMS envoyé' });
//                     })
//                     .catch(error => {
//                         console.error('Error sending SMS:', error);
//                         res.status(200).json({ message: 'État de la commande mis à jour avec succès, mais échec de l\'envoi du SMS' });
//                     });
//             } else {
//                 console.warn(`Le client de la commande ${order.code} n'a pas de numéro de téléphone valide.`);
//                 res.status(200).json({ message: 'État de la commande mis à jour avec succès, mais le client n\'a pas de numéro de téléphone valide' });
//             }
//         } else {
